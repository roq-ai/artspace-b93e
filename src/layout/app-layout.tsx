...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiImage } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['gallery-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Image', path: '/images', entity: 'image', service: AccessServiceEnum.PROJECT, icon: FiFile },
